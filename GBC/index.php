...
font-weight: bold;
   font-size: 9px;
            ...
            body {
background: url(ico/gbc.png) no-repeat  -50px 250px;
                font-family: monospace;
                font-weight: bold;
                font-size: 12px;
                margin: 0;
...
$c = count($imgArray); for($i=0; $i<$c; $i++) { echo "<option value=\"" . $imgArray[$i] . "\">" . $imgArray[$i] . "\n";
     ...
     <button id = input value="r.gbc" onclick="go();">ألعب</button>       
